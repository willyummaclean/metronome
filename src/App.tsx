  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <p>Selected BPM: {bpm}</p>
        <label>
          5/4:
          <input
            onChange={() => handleTimeSigChange(5)}
            type="radio"
            id="5/4"
            name="timeSignature"
            value="5/4"
        ...
        <label>
          4/4:
          <input
            onChange={() => handleTimeSigChange(4)}
            type="radio"
            id="4/4"
            name="timeSignature"
            value="4/4"
        ...
        <label>
          3/4:
          <input
            onChange={() => handleTimeSigChange(3)}
            type="radio"
            id="3/4"
            name="timeSignature"
            value="3/4"
        ...
        <label>
          2/4:
          <input
            onChange={() => handleTimeSigChange(2)}
            type="radio"
            id="2/4"
            name="timeSignature"
            value="2/4"
        ...
        <div>
          {timeSig !== 0 ? (
            <p>Selected Time Signature: {timeSig}/4</p>
          ) : (
            <p>Please Select A Time Signature</p>
          )}
        </div>
        <div>
          {timeSig !== 0 && clickOn === false ? (
            <div>
              <button onClick={() => setClickOn(true)} id="startButton">
                Start
              </button>
            </div>
          ) : null}
          {clickOn ? (
            <div>
              <button onClick={() => setClickOn(false)} id="stopButton">
                Stop
              </button>
            </div>
          ) : null}
